...
public class GenInvc {
    ...
    private static BigFraction amount       = BigFraction.of(1250, 100);
    // END Example data
	...
	private GnuCashWritableCustomerInvoice doCustomer(GnuCashWritableFileImpl gcshFile) throws Exception {
		...
		GnuCashWritableCustomerInvoiceEntry entry1 = invc.createEntry(incAcct, amount,
				BigFraction.of(1));
		...
		GnuCashWritableCustomerInvoiceEntry entry2 = invc.createEntry(incAcct, amount,
				BigFraction.of(1), "DE_USt_Std");
		entry2.setAction(GnuCashGenerInvoiceEntry.Action.HOURS);
		entry2.setDescription("Entry no. 2");
		entry2.setDate(dateOpen);

		GnuCashWritableCustomerInvoiceEntry entry3 = invc.createEntry(incAcct, amount,
				BigFraction.of(1), gcshFile.getTaxTableByName("FR_TVA_Std"));
	...
	private GnuCashWritableVendorBill doVendor(GnuCashWritableFileImpl gcshFile) throws Exception {
		...
		GnuCashWritableVendorBillEntry entry1 = bll.createEntry(expAcct, amount,
				BigFraction.of(1));
		entry1.setAction(GnuCashGenerInvoiceEntry.Action.JOB);
		entry1.setDescription("Entry no. 1");
		entry1.setDate(dateOpen.minus(1, ChronoUnit.DAYS));

		GnuCashWritableVendorBillEntry entry2 = bll.createEntry(expAcct, amount,
				BigFraction.of(1), "DE_USt_Std");
		entry2.setAction(GnuCashGenerInvoiceEntry.Action.HOURS);
		entry2.setDescription("Entry no. 2");
		entry2.setDate(dateOpen);

		GnuCashWritableVendorBillEntry entry3 = bll.createEntry(expAcct, amount,
				BigFraction.of(1), gcshFile.getTaxTableByName("FR_TVA_Std"));
		entry3.setAction(GnuCashGenerInvoiceEntry.Action.MATERIAL);
		entry3.setDescription("Entry no. 3");
		entry3.setDate(dateOpen.plus(1, ChronoUnit.DAYS));
	...
	private GnuCashWritableEmployeeVoucher doEmployee(GnuCashWritableFileImpl gcshFile) throws Exception {
		...
		GnuCashWritableEmployeeVoucherEntry entry1 = vch.createEntry(expAcct, amount,
				BigFraction.of(1));
		entry1.setAction(GnuCashGenerInvoiceEntry.Action.JOB);
		entry1.setDescription("Entry no. 1");
		entry1.setDate(dateOpen.minus(1, ChronoUnit.DAYS));

		GnuCashWritableEmployeeVoucherEntry entry2 = vch.createEntry(expAcct, amount,
				BigFraction.of(1), "DE_USt_Std");
		entry2.setAction(GnuCashGenerInvoiceEntry.Action.HOURS);
		entry2.setDescription("Entry no. 2");
		entry2.setDate(dateOpen);

		GnuCashWritableEmployeeVoucherEntry entry3 = vch.createEntry(expAcct, amount,
				BigFraction.of(1), gcshFile.getTaxTableByName("FR_TVA_Std"));
		entry3.setAction(GnuCashGenerInvoiceEntry.Action.MATERIAL);
		entry3.setDescription("Entry no. 3");
		entry3.setDate(dateOpen.plus(1, ChronoUnit.DAYS));
	...
	private GnuCashWritableJobInvoice doJob_cust(GnuCashWritableFileImpl gcshFile) throws Exception {
		...
		GnuCashWritableJobInvoiceEntry entry1 = invc.createEntry(incAcct, amount,
				BigFraction.of(1));
		entry1.setAction(GnuCashGenerInvoiceEntry.Action.JOB);
		entry1.setDescription("Entry no. 1");
		entry1.setDate(dateOpen.minus(1, ChronoUnit.DAYS));

		GnuCashWritableJobInvoiceEntry entry2 = invc.createEntry(incAcct, amount,
				BigFraction.of(1), "DE_USt_Std");
		entry2.setAction(GnuCashGenerInvoiceEntry.Action.HOURS);
		entry2.setDescription("Entry no. 2");
		entry2.setDate(dateOpen);

		GnuCashWritableJobInvoiceEntry entry3 = invc.createEntry(incAcct, amount,
				BigFraction.of(1), gcshFile.getTaxTableByName("FR_TVA_Std"));
		entry3.setAction(GnuCashGenerInvoiceEntry.Action.MATERIAL);
		entry3.setDescription("Entry no. 3");
		entry3.setDate(dateOpen.plus(1, ChronoUnit.DAYS));
	...
	private GnuCashWritableJobInvoice doJob_vend(GnuCashWritableFileImpl gcshFile) throws Exception {
		...
		GnuCashWritableJobInvoiceEntry entry1 = invc.createEntry(expAcct, amount, 
				BigFraction.of(1));
		entry1.setAction(GnuCashGenerInvoiceEntry.Action.JOB);
		entry1.setDescription("Entry no. 1");
		entry1.setDate(dateOpen.minus(1, ChronoUnit.DAYS));

		GnuCashWritableJobInvoiceEntry entry2 = invc.createEntry(expAcct, amount,
				BigFraction.of(1), "DE_USt_Std");
		entry2.setAction(GnuCashGenerInvoiceEntry.Action.HOURS);
		entry2.setDescription("Entry no. 2");
		entry2.setDate(dateOpen);

		GnuCashWritableJobInvoiceEntry entry3 = invc.createEntry(expAcct, amount,
				BigFraction.of(1), gcshFile.getTaxTableByName("FR_TVA_Std"));
		entry3.setAction(GnuCashGenerInvoiceEntry.Action.MATERIAL);
		entry3.setDescription("Entry no. 3");
		entry3.setDate(dateOpen.plus(1, ChronoUnit.DAYS));
